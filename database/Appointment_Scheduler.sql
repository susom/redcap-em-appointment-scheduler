...
--
-- Table structure for table `redcap_appointment_participant`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `redcap_appointment_participant` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `redcap_appointment_participant`
--
...
-- Dump completed on 2019-06-18 11:34:58


alter table redcap_appointment_participant
	add type tinyint(1) default 0 null;